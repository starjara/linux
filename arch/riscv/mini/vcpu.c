...
/*
#define KVM_ISA_EXT_ARR(ext)		[MINI_RISCV_ISA_EXT_##ext] = RISCV_ISA_EXT_##ext
...
const struct _kvm_stats_desc mini_vcpu_stats_desc[] = {
...
const struct kvm_stats_header mini_vcpu_stats_header = {
